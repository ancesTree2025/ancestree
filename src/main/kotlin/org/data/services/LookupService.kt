...
object LookupService {
    ...
    /**
     * The only exposed function, to be used for interaction with Wikipedia/Wikidata
     * and for any sort of querying.
     *
     * @param input The person's name.
     * @returns A 3-tuple of QID, Label and Family Relations.
     */
    suspend fun query(input: String):
            Pair<String, Pair<String, Map<String, List<String>>>> {
     ...
     */
    private suspend fun replaceQIDsWithNames(familyInfo: Map<String, List<String>>):
     ...
     */
    private suspend fun getPersonsLabelAndFamilyMembers(personQID: String):
        ...
        val familyInfo = replaceQIDsWithNames(parseClaimForFamily(WikiCacheManager.getClaim(personQID)!!))
